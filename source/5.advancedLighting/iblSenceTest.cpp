...
int main()
{
	...
	Shader pbrShader("./shader/IBL/gunPbr.vs", "./shader/IBL/gunPbr.fs");
	...
	//加载模型
	Model gunModel(FileSystem::getPath("resources/Cerberus_by_Andrew_Maximov/Cerberus_LP.FBX"));

	Texture  albedoTexture(FileSystem::getPath("resources/Cerberus_by_Andrew_Maximov/Textures/Cerberus_A.tga").c_str(), true, true, "albedo_Texture");
	//Texture  albedoTexture(FileSystem::getPath("resources/textures/pbr/rusted_iron/albedo.png").c_str(), true, true, "albedo_Texture");
