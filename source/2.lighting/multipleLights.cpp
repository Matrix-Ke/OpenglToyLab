...
//	Shader lightingShader("./shader/lighting/multipleLights.vs", "./shader/lighting/multipleLights.fs");
//	Shader lightCubeShader("./shader/lighting/lightCube.vs", "./shader/lighting/lightCube.fs");
//
//
...
//	else
//	{
//		std::cout << "texture load failure at path : " << path << std::endl;
//	}
//	return textureID;
//}